...
<img src="https://latex.codecogs.com/gif.latex?2S=2(h-1)+4(h-2)+8(h-3)+...+2^{h-1}" width="310" />

下式2S减去上式S得到

<img src="https://latex.codecogs.com/gif.latex?S=-h+1+2+4+...+2^{h-1}=2^{h}-1-h" width="300" />
