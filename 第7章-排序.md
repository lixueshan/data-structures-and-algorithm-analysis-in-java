...
<div align=center>
  <img src="https://tva1.sinaimg.cn/large/008i3skNgy1gze5ov9l05j30xy0jsdh3.jpg" alt="image-20220215135905862" width="150" />
</div>

故复杂度为O(n^2)。

上述复杂度为最坏及平均情形，最好情形是输入数组已排序，则无需手摇，但序列长度为n时需要的比较判断次数是n，于是最好情形的递推式为，复杂度为O(nlogn)。
